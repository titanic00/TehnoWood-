(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".objects-page__slider")) {
            new core(".objects-page__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
        ...
        if (document.querySelector(".letters-page__slider")) new core(".letters-page__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
    ...
    ymaps.ready(init);
    function init() {
        new ymaps.Map("map-footer", {
            center: [ 56.15823, 44.201316 ],
            zoom: 10
        });
    }
    window["FLS"] = true;
